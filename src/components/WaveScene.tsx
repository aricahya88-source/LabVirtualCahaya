...
export const WaveScene = forwardRef<WaveSceneHandle, WaveSceneProps>(function WaveScene({ labId, parameters }, ref) {
  ...
  useEffect(() => {
    ...
    createSimulationVisuals(scene, labId, parameters);
  }, [labId, parameters]);
